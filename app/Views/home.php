        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 text-end">
                    ...
                    <img src="/images/hero-section-img1.svg" class="pdf-main" alt="IronPDF C++ interface illustration">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="signup-content">
                        <h2 class="signup-title"><?= esc($signupSubtitle_1) ?></h2>
    ...
    <section class="feature-first-section">
        ...
        <div class="feat-title-row">
            <div class="container">
                ...
                <img src="/images/feature-title.svg" alt="">
            </div>
        </div>
